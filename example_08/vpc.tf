...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    "Name" = "Subnet pública_temp - ${local.sufix}"
  }
}
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    "Name" = "Subnet privada_temp - ${local.sufix}"
  }
  depends_on = [ 
...
resource "aws_internet_gateway" "igw" {
  ...
  tags = {
    Name = "IGW VPC London - ${local.sufix}"
  }
}
